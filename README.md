...
25. [Bài tập: Áp dụng kế thừa cho `Player` và `PlayerBullet`](ex_inheritance_player_bullet.md)
26. [Áp dụng kế thừa cho `Player` và `PlayerBullet`](inheritance_player_enemy.md)
27. [Va chạm và tiêu diệt](collision_and_destroy.md)
